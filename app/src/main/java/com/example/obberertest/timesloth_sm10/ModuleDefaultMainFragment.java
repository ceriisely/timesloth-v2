...
public class ModuleDefaultMainFragment extends Fragment {
    ...
    void updateScheduleBar(){
        ...
        for (int i=0;i<Main_activity.Main_Room.RoomSchedule.size();i++){
            Schedule _schedule = Main_activity.Main_Room.RoomSchedule.get(i);
            if(_schedule.Status){
                int count = 0;
    ...
    void updateUIScheduleValid(){
        ...
        for (int i=0;i<Main_activity.ScheduleValid.size();i++){
            Schedule schedule = Main_activity.ScheduleValid.get(i);
