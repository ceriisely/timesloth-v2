    ...
    private void bindButton() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Main_activity.getFragmentManager().beginTransaction().remove(Main_activity.module_find_all_room_fragment).commit();
                } catch (IllegalStateException e) {
                    Main_activity.getFragmentManager().beginTransaction().remove(Main_activity.module_find_all_room_fragment).commitAllowingStateLoss();
                }
            }
        });
    }
